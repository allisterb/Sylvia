...
module HtmlVisualization =
    ...
    let draw_realfun<'a when 'a: not null> (attrs:'a) (name:string) (e:Expr<real->real>)  = 
    ...
    let draw_realfun2<'a when 'a: not null> (attrs:'a) (name:string) (e:Expr<real->real>)  = 
    ...
    let draw_realfuns<'a when 'a: not null> (attrs:'a) (names:string[]) (exprs:Expr<real->real>[])  = 
        let xrange = get_prop_else<real*real> "xrange" (0. ,10.) attrs 
